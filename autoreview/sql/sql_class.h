...
/*plan result*/
typedef struct sql_plan_result_node_struct sql_plan_result_node_t;
struct sql_plan_result_node_struct
{
    int      id;
    char     select_type[NAME_CHAR_LEN];
    char     table[NAME_CHAR_LEN];
    char     type[NAME_CHAR_LEN];
    char     possible_keys[NAME_CHAR_LEN];
    char     key[NAME_CHAR_LEN];
    int      key_len;
    char     ref[NAME_CHAR_LEN];
    my_ulonglong        rows;
    char       extra[NAME_CHAR_LEN];
    
    LIST_NODE_T(sql_plan_result_node_struct) link;
};

/*json_body*/
typedef struct json_struct json_t;
struct json_struct
{
    int      port;
    char     dbName[NAME_CHAR_LEN];
    char     ip[NAME_CHAR_LEN];
    char     dalGroup[NAME_CHAR_LEN];
    char*    sql;
};
...
typedef struct sql_plan_result_struct sql_plan_result_t;
struct sql_plan_result_struct
{
    LIST_BASE_NODE_T(sql_plan_result_node_t) sql_plan_lst;
    char*                                    sql_statements;
    int                                      is_send_judge;
    int                                      is_wild;
    int                                      is_drc;
